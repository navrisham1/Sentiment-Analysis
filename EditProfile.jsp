...
<body>
   ...
   <div id="wrapper">
        ...
        <%@include file="Navigation.jsp" %>
         <%
            ...
            %>   
              <form action="EditProfile" method="post" onsubmit="return validForm()">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                          	 <div class="dtls">
						 <h1 style="color:#02C8FF;"> Edit Profile </h1>
						 <h4> Username: <span id="usr-unm" style="color:#000;">  </span> </h4>
                                                
                                                 
                                                 <h4> Name: <span id="usr-nm" style="color:#000;"> <input type="text" id="txtname" name="txtname" value=<%=objbean.getName()%> </span> </h4>
			                         <% if (objbean.isGender()) {%>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p> Email Id:emotionalysis@gmail.com
            <p> Phone Number:+91-7837188780</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
