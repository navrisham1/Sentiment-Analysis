            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                         ...
                         <form class="inner-width" action="SavePassword" method="post" onsubmit="return validForm()">
                         	<div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Current Password</label>
                                <div class="col-sm-8">
                                  <input type="password" class="form-control" id="txtoldpassword" name="txtoldpassword" placeholder="Current Password" style="margin-bottom:20px;">
                                </div>
                              </div>
                              <div class="form-group">
							   ...
							   <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  <input type="password" class="form-control" id="txtnewconfirm" name="txtnewconfirm" placeholder="Confirm Password" style="margin-bottom:60px;">
                                </div>
                              </div>
                            ...
                            <div class="form-group text-center post-cancel">
                                ...
                                <button type="submit" class="btn btn-default btn-danger" style="margin:10px 20px;">Cancel</button>
                            </div>	
