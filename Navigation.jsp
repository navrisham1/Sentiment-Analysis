    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li class="active">
                    <a href="ViewProfile.jsp"><i class="fa fa-envelope" aria-hidden="true"></i> View Profile</a>
                </li>
                <li>
                    <a href="Rating.jsp"><i class="fa fa-star-o" aria-hidden="true" style="font-size:20px;"></i>  Rating</a>
                </li>

                <li>
                    <a href="Logout" onclick="logOutAll()"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
                </li>  	
